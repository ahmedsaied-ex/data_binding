...
import com.example.testdatabinding.ui.fragments.MapsActivity

class DetailsNavigationImpl : ITripNavigatorDetails{
    ...
    override fun openActivity(activity: AppCompatActivity, trip: TripModel, callback: (TripModel) -> Unit) {
    ...
    override fun returnResult(activity: AppCompatActivity, trip: TripModel?) {
